<x-app-layout>
    <x-slot name="slot" class="mt-4">
        <button type="submit" onclick="window.location='{{ url('pemasok') }}'" class="text-white bg-yellow-600 hover:bg-yellow-700 focus:ring-2 focus:outline-none focus:ring-yellow-300 font-medium rounded-lg text-sm w-full sm:w-auto px-4 py-2 text-center dark:bg-yellow-500 dark:hover:bg-yellow-600 dark:focus:ring-yellow-700 mb-2 float-right">
