<div class="relative overflow-x-auto shadow-md sm:rounded-lg mt-5">
    ...
    <nav class="flex items-center justify-between pt-4 m-3" aria-label="Table navigation">
        <span class="text-sm font-normal text-gray-500 dark:text-gray-400 m-3">Showing <span class="font-semibold text-gray-900 dark:text-white">1-10</span> of <span class="font-semibold text-gray-900 dark:text-white">1000</span></span>
